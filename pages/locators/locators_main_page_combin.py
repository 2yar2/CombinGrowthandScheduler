...
# FIRST CARDS
    ...
    CARDGROWTHCONTENT = (By.XPATH, '/html/body/div[1]/section[1]/div/div[2]/a[1]/div[1]')
    ...
    CARDSCHEDULERCONTENT = (By.XPATH, '/html/body/div[1]/section[1]/div/div[2]/a[2]/div[1]')
...
# Открытие ссылок ПЕРВЫХ КАРТОЧЕК на ГЛАВНОЙ странице КОМБИН
    # FIRST CARD GROWTH
    CARDGROWTHBUTTONLEARNMORE = (By.XPATH, '/html/body/div[1]/section[1]/div/div[2]/a[1]/div[2]/div') #CLICK
